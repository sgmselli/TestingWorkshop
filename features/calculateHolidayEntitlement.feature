...
Scenario: Updates calculation when value is edited
    ...
    And I input 40 hours worked per week changed
    And I input 5 days worked per week changed
    Then I should see the correct submitted answers for regular hours changed
    And I should see 224 total entitlement hours changed
